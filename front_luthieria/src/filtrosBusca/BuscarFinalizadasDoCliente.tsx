...
function BuscarFinalizadasDoCliente() {
  ...
  function realizarBusca(e: any) {
    ...
    axios
      .get<OrdemDeServico[]>(`http://localhost:5028/ordemservico/finalizadas/cliente/${clienteId}`)
      .then((resposta) => {
  ...
  function deletarOrdemSevico(ordemDeServicoId: number) {
    ...
    return (
      <div className="container">
        <h1>Buscar Todos os Pedidos Finalizados de um Cliente:</h1>
        ...
        <h1>Todos os Pedidos Finalizados do Cliente: {clienteNome}</h1>
...
export default BuscarFinalizadasDoCliente;
